...
print( "<style>."+get_tag()+"{height:1px;width:1px;padding:0px;}")
...
print( "</style><table style='border-spacing:0px;left:0;top:0;position:absolute;'>")
for x in range(0, size[1]):
    print("<tr>")
    for y in range(0, size[0]):
        print("<td class='a "+colors[get_color(pix[y,x])]+"'></td>")
    print("</tr>")
print "</table>"